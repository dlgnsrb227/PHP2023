<?php
    ...
    if($result){
        ...
        if($info['MemberID'] == $memberID && $info['youPass'] == $boardPass){
            $sql = "UPDATE board SET boardName = '$boardName', boardTitle = '$boardTitle', boardIngre = '$boardIngre' WHERE boardID='$boardID'";
            $connect -> query($sql);
            for($i=1; $i<=$count; $i++){
                $ii = $i-1;
                $sql = "UPDATE board SET boardContents$i = '$boardArray[$ii]' WHERE boardID = '$boardID'";
                $connect -> query($sql);
            }
            ...
            if($_FILES['boardImg1']['name'] != ""){
                ...
                $sql = "UPDATE board SET ImgSrc1 = '$boardImgName1', ImgSize1 = '$boardImgSize1' WHERE boardID = '$boardID'";
                $connect -> query($sql);
            }
            if(isset($_FILES['boardImg2'])){
                if($_FILES['boardImg2']['name'] != ""){
                    ...
                    $sql = "UPDATE board SET ImgSrc2 = '$boardImgName2', ImgSize2 = '$boardImgSize2' WHERE boardID = '$boardID'";
                    $connect -> query($sql);
                }
            }
            if(isset($_FILES['boardImg3'])){
                if($_FILES['boardImg3']['name'] != ""){
                    ...
                    $sql = "UPDATE board SET ImgSrc3 = '$boardImgName3', ImgSize3 = '$boardImgSize3' WHERE boardID = '$boardID'";
                    $connect -> query($sql);
                }
            }
            if(isset($_FILES['boardImg4'])){
                if($_FILES['boardImg4']['name'] != ""){
                    ...
                    $sql = "UPDATE board SET ImgSrc4 = '$boardImgName4', ImgSize4 = '$boardImgSize4' WHERE boardID = '$boardID'";
                    $connect -> query($sql);
                }
            }
            if(isset($_FILES['boardImg5'])){
                if($_FILES['boardImg5']['name'] != ""){
                    ...
                    $sql = "UPDATE board SET ImgSrc5 = '$boardImgName5', ImgSize5 = '$boardImgSize5' WHERE boardID = '$boardID'";
                    $connect -> query($sql);
                }
            }
        } else {
